...
const AssignmentsPage: NextPage = () => {
  ...
  const renderStatus = (status: AssignmentStatus) => {
    switch(status) {
      case 'completed':
        return (
  ...
  return (
    <ProtectedRoute>
      <DashboardLayout title="Tareas" description="Gestiona tus tareas y actividades">
        <div className="p-6 bg-gray-50 min-h-screen">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Tareas</h1>
