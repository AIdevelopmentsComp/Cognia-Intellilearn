            ...
            return (
              <div key={step} className="flex items-center">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                  isActive ? 'neuro-button-primary text-white' : 
              ...
              {lessonTypes.map((lessonType) => {
                ...
                return (
                  <button
                    ...
                    className={`neuro-container rounded-xl p-6 text-left transition-all duration-300 hover:bg-gray-50 ${
                      isSelected ? 'ring-2 ring-[#3C31A3] bg-blue-50' : ''
                    }`}
                  >
                    <div className="flex items-start space-x-4">
                      <div className={`neuro-container w-12 h-12 rounded-xl flex items-center justify-center ${lessonType.bgColor}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full neuro-inset px-4 py-3 rounded-lg text-[#132944] bg-transparent border-none outline-none focus:ring-2 focus:ring-[#3C31A3]"
                  autoFocus
                />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center neuro-inset">
                  <button
                    onClick={() => fileInputRef.current?.click()}
                    disabled={uploading}
                    className="neuro-button-primary px-6 py-3 rounded-lg text-white flex items-center space-x-2 mx-auto transition-all duration-300 disabled:opacity-50"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="neuro-container rounded-xl p-6">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                ...
                <div className="neuro-inset rounded-lg p-4 mt-2 max-h-32 overflow-y-auto">
                  <div 
